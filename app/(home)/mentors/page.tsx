...
const page = async () => {
  ...
  return (
    <div className="relative mx-auto ">
      ...
      <div className=" w-9/12 mx-auto xs:-mt-28 md:-mt-52 lg:mt-40 uws:mt-60 grid xs:grid-cols-2  sm:grid-cols-2 md:grid-cols-3 lg: grid-cols-4 exl:grid-cols-4 uws:grid-cols-4">
        {mentors?.map((mentor, idx: number) => (
          <Link
            href={`#`}
            key={idx}
            className={
              "w-11/12 xs:h-[200px] md:h-[250px] lg:h-[465px] uws:h-[650px] text-center xs:mt-1 mt-8 flex flex-col items-center"
            }
          >
            <div
              className={
